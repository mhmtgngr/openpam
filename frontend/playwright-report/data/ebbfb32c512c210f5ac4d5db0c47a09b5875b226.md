                  ...
                  - generic [ref=e191]:
                    ...
                    - generic [ref=e240]:
                      ...
                      - generic [ref=e244]:
                        - generic [ref=e245]:
                          - img [ref=e246]
                          - paragraph [ref=e248]: No conditions defined
                          - paragraph [ref=e249]: Add conditions to control when this rule applies
                        - button "Add Condition" [ref=e250] [cursor=pointer]:
                          - img [ref=e252]
                          - text: Add Condition
                - button "Add Rule" [ref=e253] [cursor=pointer]:
                  - img [ref=e255]
                  - text: Add Rule
            - generic [ref=e258]:
              - heading "Effective Period (Optional)" [level=3] [ref=e259]
              - paragraph [ref=e260]: Set a time range for when this policy should be active
              - generic [ref=e261]:
                - generic [ref=e262]:
                  - generic [ref=e263]: Effective From
                  - textbox [ref=e266]
                - generic [ref=e267]:
                  - generic [ref=e268]: Effective Until
                  - textbox [ref=e271]
            - generic [ref=e272]:
              - generic [ref=e273]: 1 allow,0 deny rules
              - generic [ref=e274]:
                - link "Cancel" [ref=e275] [cursor=pointer]:
                  - /url: /policies/access
                  - button "Cancel" [ref=e276]
                - button "Create Policy" [ref=e277] [cursor=pointer]:
                  - img [ref=e279]
                  - text: Create Policy
  - generic:
    - status [ref=e288]: An error occurred
    - status [ref=e294]: An error occurred
```