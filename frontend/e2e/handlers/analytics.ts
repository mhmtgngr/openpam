...
const mockAnomalies = [
  {
    ...
    description: 'User accessed sensitive resources outside normal hours',
    user_id: 'user-3',
    user_name: 'Bob Johnson',
    confidence_score: 85,
    risk_score: 75,
  ...
  {
    id: 'anom-2',
    anomaly_type: 'ransomware',
    severity: 'critical',
    title: 'Potential ransomware activity',
    description: 'Multiple file encryption operations detected',
    user_id: 'user-1',
    user_name: 'John Doe',
    confidence_score: 92,
    risk_score: 95,
  ...
  {
    id: 'anom-3',
    anomaly_type: 'credential',
    severity: 'medium',
    title: 'Unusual credential usage',
    description: 'Credential used from new location',
    user_id: 'user-2',
    user_name: 'Jane Smith',
    confidence_score: 70,
    risk_score: 50,
