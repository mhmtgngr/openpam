      ...
      - main [ref=e106]:
        - generic [ref=e107]:
          ...
          - table [ref=e129]:
            ...
            - rowgroup [ref=e139]:
              - row "John Doe john@example.com SSH Server ssh SSH active 2/25/2026, 6:46:53 AM 0m 0s Terminate Monitor" [ref=e140]:
                - cell "John Doe john@example.com" [ref=e141]:
                  - generic [ref=e142]:
                    - paragraph [ref=e143]: John Doe
                    - paragraph [ref=e144]: john@example.com
                - cell "SSH Server ssh" [ref=e145]:
                  - generic [ref=e146]:
                    - paragraph [ref=e147]: SSH Server
                    - paragraph [ref=e148]: ssh
                - cell "SSH" [ref=e149]:
                  - generic [ref=e150]: SSH
                - cell "active" [ref=e151]:
                  - generic [ref=e156]: active
                - cell "2/25/2026, 6:46:53 AM" [ref=e157]
                - cell "0m 0s" [ref=e158]:
                  - generic [ref=e159]: 0m 0s
                - cell "Terminate Monitor" [ref=e160]:
                  - generic [ref=e161]:
                    - button "Terminate" [ref=e162] [cursor=pointer]:
                      - img [ref=e164]
                      - text: Terminate
                    - link "Monitor" [ref=e167] [cursor=pointer]:
                      ...
                      - button "Monitor" [ref=e168]:
                        ...
                        - text: Monitor
  - generic:
    - status [ref=e178]: An error occurred
    - status [ref=e184]: An error occurred
```