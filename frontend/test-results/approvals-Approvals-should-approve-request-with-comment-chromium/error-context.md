...
- generic [ref=e3]:
  ...
  - generic [ref=e76]:
    ...
    - main [ref=e102]:
      - generic [ref=e103]:
        - generic [ref=e105]:
          - heading "Pending Approvals" [level=1] [ref=e106]
          - paragraph [ref=e107]: Review and respond to access requests
        - generic [ref=e111]:
          - img [ref=e113]
          - textbox "Search requests..." [ref=e116]
        - paragraph [ref=e119]: No pending approvals
```