        ...
        - generic [ref=e116]:
          ...
          - generic [ref=e201]:
            ...
            - table [ref=e207]:
              ...
              - rowgroup [ref=e221]:
                - row "critical Unusual Access Time Unusual After-Hours Access User accessed production system at 3 AM Admin User prod-server-01 Feb 25, 09:45 92% Open View" [ref=e222]:
                  - cell [ref=e223]:
                    - checkbox [ref=e224]
                  ...
                  - cell "Feb 25, 09:45" [ref=e248]:
                    - generic [ref=e249]:
                      - img [ref=e250]
                      - generic [ref=e253]: Feb 25, 09:45
                  - cell "92%" [ref=e254]:
                    - generic [ref=e257]: 92%
                  - cell "Open" [ref=e260]:
                    - generic [ref=e261]:
                  ...
                  - cell "View" [ref=e265]:
                    - button "View" [ref=e267] [cursor=pointer]:
                      - img [ref=e269]
                      - text: View
                - row "high Privileged Escalation Sudden Privilege Escalation User escalated privileges multiple times in short period Regular User prod-server-01 Feb 25, 08:45 85% Investigating View" [ref=e272]:
                  - cell [ref=e273]:
                    - checkbox [ref=e274]
                  - cell "high" [ref=e275]:
                    - generic [ref=e276]:
                  ...
                  - cell "Feb 25, 08:45" [ref=e298]:
                    - generic [ref=e299]:
                      - img [ref=e300]
                      - generic [ref=e303]: Feb 25, 08:45
                  - cell "85%" [ref=e304]:
                    - generic [ref=e307]: 85%
                  ...
                  - cell "View" [ref=e316]:
                    - button "View" [ref=e318] [cursor=pointer]:
                      - img [ref=e320]
                      - text: View
                - row "medium Unusual Location Access from Unusual Location Login detected from previously unseen geographic location Dev User staging-db-01 Feb 25, 07:45 75% Open View" [ref=e323]:
                  - cell [ref=e324]:
                    - checkbox [ref=e325]
                  ...
                  - cell "Feb 25, 07:45" [ref=e349]:
                    - generic [ref=e350]:
                      - img [ref=e351]
                      - generic [ref=e354]: Feb 25, 07:45
                  - cell "75%" [ref=e355]:
                    - generic [ref=e358]: 75%
                  - cell "Open" [ref=e361]:
                    - generic [ref=e362]:
                  ...
                  - cell "View" [ref=e366]:
                    - button "View" [ref=e368] [cursor=pointer]:
                      - img [ref=e370]
                      - text: View
                - row "high Bulk Data Access Bulk Data Export Detected Large volume of data exported from database Admin User prod-db-01 Feb 25, 06:45 88% Open View" [ref=e373]:
                  - cell [ref=e374]:
                    - checkbox [ref=e375]
                  - cell "high" [ref=e376]:
                    - generic [ref=e377]:
                  ...
                  - cell "Feb 25, 06:45" [ref=e399]:
                    - generic [ref=e400]:
                      - img [ref=e401]
                      - generic [ref=e404]: Feb 25, 06:45
                  - cell "88%" [ref=e405]:
                    - generic [ref=e408]: 88%
                  - cell "Open" [ref=e411]:
                    - generic [ref=e412]:
                  ...
                  - cell "View" [ref=e416]:
                    - button "View" [ref=e418] [cursor=pointer]:
                      - img [ref=e420]
                      - text: View
                - row "critical Command Injection Potential Command Injection Suspicious command pattern detected in session Contractor prod-server-01 Feb 25, 05:45 95% Resolved View" [ref=e423]:
                  - cell [ref=e424]:
                    - checkbox [ref=e425]
                  ...
                  - cell "Feb 25, 05:45" [ref=e449]:
                    - generic [ref=e450]:
                      - img [ref=e451]
                      - generic [ref=e454]: Feb 25, 05:45
                  - cell "95%" [ref=e455]:
                    - generic [ref=e458]: 95%
