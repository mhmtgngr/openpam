  ...
  - generic [ref=e80]:
    ...
    - main [ref=e106]:
      - generic [ref=e107]:
        - generic [ref=e108]:
          - generic [ref=e109]:
            - heading "My Requests" [level=1] [ref=e110]
            - paragraph [ref=e111]: View and manage your access requests
          - link "New Request" [ref=e112] [cursor=pointer]:
            - /url: /requests/new
            - button "New Request" [ref=e113]:
              - img [ref=e115]
              - text: New Request
        - generic [ref=e118]:
          - generic [ref=e121]:
            - img [ref=e123]
            - textbox "Search requests..." [ref=e126]
          - combobox [ref=e128]:
            - option "All Status"
            ...
            - option "Completed"
            - option "Cancelled"
        - paragraph [ref=e131]: No requests found
```