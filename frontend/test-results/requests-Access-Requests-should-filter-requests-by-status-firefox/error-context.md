  ...
  - generic [ref=e82]:
    ...
    - main [ref=e108]:
      - generic [ref=e109]:
        - generic [ref=e110]:
          - generic [ref=e111]:
            - heading "My Requests" [level=1] [ref=e112]
            - paragraph [ref=e113]: View and manage your access requests
          - link "New Request" [ref=e114] [cursor=pointer]:
            - /url: /requests/new
            - button "New Request" [ref=e115]:
              - img [ref=e117]
              - text: New Request
        - generic [ref=e122]:
          - generic [ref=e125]:
            - img [ref=e127]
            - textbox "Search requests..." [ref=e130]
          - combobox [ref=e132]:
            - option "All Status"
            ...
            - option "Completed"
            - option "Cancelled"
        - paragraph [ref=e135]: No requests found
```