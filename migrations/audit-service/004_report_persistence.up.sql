...
-- ============================================================================
-- Update compliance_reports Table with missing columns
-- ============================================================================
-- Add updated_at and expires_at columns to existing compliance_reports table

ALTER TABLE compliance_reports
    ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    ADD COLUMN IF NOT EXISTS expires_at TIMESTAMPTZ;

-- Create index for expires_at on compliance_reports
CREATE INDEX IF NOT EXISTS idx_compliance_reports_expires_at
    ON compliance_reports(expires_at)
    WHERE expires_at IS NOT NULL;

-- Apply updated_at trigger to compliance_reports
...
-- Enable RLS on compliance_reports if not already enabled
DO $$
BEGIN
    IF NOT EXISTS (
...
-- Create RLS policy for compliance_reports if it doesn't exist
